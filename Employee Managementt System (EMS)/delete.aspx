<%@ Page Title="" Language="C#" MasterPageFile="~/adminmaster.master" AutoEventWireup="true" CodeFile="delete.aspx.cs" Inherits="delete" %>
...
<center>
<div style="width: 50%">
 <h2 style="background-color: #009688">Delete</h2>
 <h3 style="color:#FFFFFF; background-color: #808080; height: 35px;">Search Employee:</h3>
    ...
    <div class="row justify-content-center">
      ...
      <asp:GridView ID="GridView1" runat="server" EmptyDataText="No data Found" 
              ...
              onrowdeleting="GridView1_RowDeleting" DataKeyNames="empid" CellPadding="4" 
              ForeColor="White" GridLines="None" BackColor="Gray" BorderColor="Black" 
              BorderWidth="2px">
